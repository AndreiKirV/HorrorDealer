...
public class Outline : MonoBehaviour {
  ...
  [SerializeField] private bool decreasingWithDistance = true;
  ...
  void Update() {
    ...
    //outlineWidth = maxWidth / Vector3.Distance(gameObject.transform.position, cam.transform.position);

    /* if(decreasingWithDistance)
    {
      float distance = Vector3.Distance(transform.position, cam.transform.position);

      OutlineWidth = maxWidth / distance;
    } */
  }
